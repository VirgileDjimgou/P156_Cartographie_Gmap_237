...
public class PhoneAuthActivity extends AppCompatActivity implements
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(tech.ioengine.Login.R.layout.activity_phone);
        ...
        ccp = (CountryCodePicker) findViewById(tech.ioengine.Login.R.id.ccp);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case tech.ioengine.Login.R.id.button_start_verification:
